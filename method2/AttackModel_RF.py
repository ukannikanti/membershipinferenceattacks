...
# Load the dataset
positive_df = pd.read_csv('./data/attack/train_1.csv')
negative_df = pd.read_csv('./data/attack/train_0.csv')
...
clf = RandomForestClassifier(n_estimators=64, max_depth=512, random_state=0).fit(train_features, train_labels)
